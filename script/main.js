...
window.onload = function() {
	...
	this.thread = setInterval(function() {
		if (window.resource.curr_amount == window.resource.total_amount) {
			...
			ctx.fillText(" Carregando recursos do jogo, aguarde...  " + (window.resource.curr_amount / window.resource.total_amount * 100).toFixed(2) + "%", window.WIDTH / 2,  window.HEIGHT / 2);
		}
